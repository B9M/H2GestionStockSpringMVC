...
<title><fmt:message code="common.titre"></fmt:message></title>
					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							...
							<c:url value="/utilisateur/enregistrer" var="urlEnregistrer"/>
								...
								<%-- 	<div class="form-group">
										<label><fmt:message code="common.addresse" /></label>
										<f:input path="addresse" class="form-control"
									...
									<div class="panel-footer">
										...
										<a href="<c:url value="/utilisateur/"/>" class="btn btn-danger">
