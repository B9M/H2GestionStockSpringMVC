				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<fmt:message code="common.utilisateur" />
						</h1>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
								<li><a href="<c:url value="/utilisateur/nouveau"/>"><i
									...
									<table width="100%"
										...
										<tbody>
											...
											<c:forEach items="${utilisateurs }" var="utilisateur">
												<tr class="odd gradeX">
													<td class="center"><img src="${utilisateur.getPhoto() }"
														width="50px" height="50px" /></td>
													<td>${utilisateur.getNom() }</td>
													<td>${utilisateur.getPrenom() }</td>
													<td>${utilisateur.getMail() }</td>
													<td><c:url
															value="/utilisateur/modifier/${utilisateur.getIdUtilisateur() }"
															var="userModif" /> <a href="${userModif }"><i
															class="fa fa-edit"></i></a>&nbsp;|&nbsp; <a
														href="javascript:void(0)" data-toggle="modal"
														data-target="#modalUtilisateur${utilisateur.getIdUtilisateur() }"><i
															class="fa fa-trash-o">&nbsp;</i></a>
														<div class="modal fade"
															id="modalUtilisateur${utilisateur.getIdUtilisateur() }" tabindex="-1"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		: <br>
																		<br> <img src="${utilisateur.getPhoto() }"
																	...
																	<div class="modal-footer">
																		...
																		<c:url
																			value="/utilisateur/supprimer/${utilisateur.getIdUtilisateur() }"
