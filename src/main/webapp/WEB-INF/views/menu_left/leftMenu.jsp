<div class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li><a href="${article }"><i class="fa fa-file-o"></i>
					<fmt:message code="common.article" /> </a></li>

			<li><a href="#"><i class="fa fa-user"></i> <fmt:message code="common.client" /><span class="fa arrow"></span></a>
			...
			<li><a href="${stock }"><i class="fa fa-shopping-cart "></i>
					<fmt:message code="common.stock" /> </a></li>

			<c:url value="/vente/" var="vente" />
			<li><a href="${vente }"><i class="fa fa-bar-chart"></i>
					<fmt:message code="common.vente" /> </a></li>

			<c:url value="/category/" var="category" />
			<li><a href="${category }"><i class="fa fa-th-list  "></i>
					<fmt:message code="common.category" /> </a></li>


			<li><a href="#"><i class="fa  fa-wrench fa-fw"></i> <fmt:message
						code="common.parametrage" /><span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<c:url value="/parametrage/" var="parametrage" />
					<li><a href="${parametrage }"><fmt:message code="common.parametrage" /></a></li>
					<c:url value="/utilisateur/" var="utilisateur" />
					<li><a href="${utilisateur }"><fmt:message code="common.parametrage.utilisateur" /></a></li>
				</ul> <!-- /.nav-second-level --></li>
