...
<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<fmt:message code="common.category" />
						</h1>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
								<li><a href="<c:url value="/category/nouveau"/>"><i
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<table width="100%"
										...
										<thead>
											<tr>
												<th><fmt:message code="category.codeCategory" /></th>
 ...
 <c:url value="/category/modifier/${category.getIdCategory() }" var="catModif" /> 
 <a href="${catModif }"><i class="fa fa-edit"></i></a>&nbsp;|&nbsp; 
 <a href="javascript:void(0)" data-toggle="modal" data-target="#modalCategory${category.getIdCategory() }">
 <i class="fa fa-trash-o">&nbsp;</i></a>
														<div class="modal fade"
															id="modalCategory${category.getIdCategory() }" tabindex="-1"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		: <br>
																		<br>  &nbsp;&nbsp;&nbsp;<label>- Code Category : &nbsp;</label>
																			${category.getCodeCategory() } |||&nbsp;<label> Designation : 
																	...
																	<div class="modal-footer">
																		...
																		<c:url
																			value="/category/supprimer/${category.getIdCategory()}"
