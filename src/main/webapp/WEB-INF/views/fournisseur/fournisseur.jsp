			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
								<li><a href="<c:url value="/fournisseur/nouveau"/>"><i
										...
										<tbody>
											...
											<c:forEach items="${fournisseurs }" var="fournisseur">
												<tr class="odd gradeX">
													...
													<td>${fournisseur.getAddresse() }</td>
													<td>${fournisseur.getEmail() }</td>
													<td><c:url
															value="/fournisseur/modifier/${fournisseur.getIdFournisseur() }"
															var="fourModif" /> <a href="${fourModif }"><i
															class="fa fa-edit"></i></a>&nbsp;|&nbsp; <a
														href="javascript:void(0)" data-toggle="modal"
														data-target="#modalFournisseur${fournisseur.getIdFournisseur() }"><i
															class="fa fa-trash-o">&nbsp;</i></a>
														<div class="modal fade"
															id="modalFournisseur${fournisseur.getIdFournisseur() }" tabindex="-1"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		: <br>
																		<br> <img src="${fournisseur.getPhoto() }"
																			width="100px" height="120px" /> &nbsp;&nbsp;&nbsp;<label>-&nbsp;
																			${fournisseur.getNom() } &nbsp;${fournisseur.getPrenom() } </label>
																	</div>
